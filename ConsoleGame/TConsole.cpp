...
TConsole::TConsole(TConsole& Console) :In(std::cin), Out(std::cout)
{
    InputHandle = Console.InputHandle;
    OutputHandle = Console.OutputHandle;
    ScreenBufInfo = Console.ScreenBufInfo;
